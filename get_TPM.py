...
import sys
print("Load data ...")
df = pd.read_csv('/BioII/lulab_b/liuxiaofan/project/expanel/HCC/pico/count_matrix/exp_data.txt',sep="\t")
...
label = pd.read_csv('/BioII/lulab_b/liuxiaofan/project/expanel/HCC/pico/data/label_data.txt',sep='\t')
...
data_all=pd.concat([data_NC,data_HCC],axis=1)
data_all=data_all.reset_index()
data_all.to_csv('/BioII/lulab_b/liuxiaofan/project/expanel/HCC/pico/count_matrix/exp_TPM.txt',sep='\t',index=False)
...
data.to_csv('/BioII/lulab_b/liuxiaofan/project/expanel/HCC/pico/result/TPM_mean.txt',sep='\t',index=False)
